...
function crearClasePersona() {
  class Persona {
    ...
    addFriend(nombre, edad) {
      ...
      // Tu código aca:
      this.amigos[1] = { nombre: nombre, edad: edad};
    }
    ...
    getFriends() {
      ...
      // Tu código aca:
      return  [this.amigos[0].nombre, this.amigos[1].nombre]
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      return  (this.amigos[0].edad + this.amigos[1].edad) / 2
    }
  };
